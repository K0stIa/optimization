...
cdef public api double cy_call_oracle(object self, object  w, object grad, int *error):
    print "[cy]  cy_call_oracle: "
    try:
        func = self.oracle
    except AttributeError:
        error[0] = 1
...
cpdef public api double cy_call_risk(object self, double * w, double *grad, int *error):
    print "[cy]  cy_call_oracle: "
    try:
        func = self.oracle
    except AttributeError:
