...
__PYX_EXTERN_C DL_IMPORT(IAlg) *__pyx_f_5cyfwk_cy_create_alg(void);
__PYX_EXTERN_C DL_IMPORT(void) cy_call_run(PyObject *, int *);
__PYX_EXTERN_C DL_IMPORT(void) cy_call_jump(PyObject *, int, int *);
__PYX_EXTERN_C DL_IMPORT(double) cy_call_oracle(PyObject *, PyObject *, PyObject *, int *);
